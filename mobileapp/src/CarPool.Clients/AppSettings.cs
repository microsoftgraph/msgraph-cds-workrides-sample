...
namespace CarPool.Clients
{
    ...
    {
        public const string CarpoolClientId = "<INSERT YOUR CLIENTID>";

        // Graph API
        public const string GraphApiEndpoint = "https://graph.microsoft.com/";
        //A redirect uri gives AAD more details about the specific application that it will authenticate.  
        //Since a client app does not have an external service to redirect to, this Uri is the standard placeholder for a client app.  
        public const string GraphRedirectUri = "<INSERT YOUR RETURN URL>";
        // Create an instance of AuthenticationContext to acquire an Azure access token  
        // OAuth2 authority Uri  
        public const string GraphAuthorityUri = "https://login.windows.net/<INSERT_YOUR_TENANT>";
        
        // CDS
        public const string CdsResourceUri = "http://rts.powerapps.com";
        //A redirect uri gives AAD more details about the specific application that it will authenticate.  
        //Since a client app does not have an external service to redirect to, this Uri is the standard placeholder for a client app.  
        public const string CdsRedirectUri = "<INSERT YOUR RETURN URL>";
        // Create an instance of AuthenticationContext to acquire an Azure access token  
        // OAuth2 authority Uri  
        ...
        // HockeyApp
        public const string HockeyAppiOS = "<INSERT YOUR HOCKEYAPP KEY>";
        public const string HockeyAppAndroid = "<INSERT YOUR HOCKEYAPP KEY>";
        public const string HockeyAppUWP = "<INSERT YOUR HOCKEYAPP KEY>";
    }
}