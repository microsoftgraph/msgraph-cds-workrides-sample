...
namespace CarPool.Clients.Core.Maps.Extensions
{
    public static class MapExtensions
    {
        public static void SetPosition(this Map map, Position position)
        {
            SetPosition(map, position, Distance.FromMiles(map.VisibleRegion.Radius.Miles));
        }

        public static void SetPosition(this Map map, Position position, Distance distance)
        {
