...
namespace CarPool.Clients.Core.Maps.Routes
{
    public class RoutesUpdater
    {
        ...
        public double UserSpeed { get; set; }
        ...
        private void CalculateRouteStep(Route route)
        {
            ...
            double maxStepDistance = UserSpeed * UpdateInterval.TotalHours;

            Position origin = route.CurrentPosition;
            Position destination = route.NextPosition;
            ...
            else
            {
                ...
                var nextGeoposition = new Position(origin.Latitude + (latDiff * distanceProportion),
                                                   origin.Longitude + (lonDiff * distanceProportion));
